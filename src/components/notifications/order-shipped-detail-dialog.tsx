...
interface OrderShippedDetailDialogProps {
  open?: boolean
        ...
        <div className='flex flex-col gap-6 py-4'>
          <div className='grid grid-cols-2 gap-4'>
            <div className='flex flex-col gap-2'>
              <Label>发货单号</Label>
              <Input value={detail.发货单号 || '-'} disabled />
            </div>
            <div className='flex flex-col gap-2'>
              <Label>快递单号</Label>
              <Input value={detail.快递单号 || '-'} disabled />
            </div>
          </div>
          <div className='grid grid-cols-2 gap-4'>
            <div className='flex flex-col gap-2'>
          ...
          <div className='flex flex-col gap-2'>
            <Label>发货总金额</Label>
            <Input
              value={detail.发货总金额 ? `¥${detail.发货总金额}` : '-'}
              disabled
            />
          </div>
          <div className='flex flex-col gap-2'>
            ...
            {detail.订单项目 && detail.订单项目.length > 0 ? (
              ...
              <p className='text-muted-foreground'>暂无发货项目</p>
            )}
          </div>
        </div>
      </DialogContent>
