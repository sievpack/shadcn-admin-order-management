...
import { accountsPayableColumns, type AccountsPayable } from './ap-columns'

const route = getRouteApi('/_authenticated/finance/ap')
  ...
  return (
    ...
    >
      <DataTableToolbar
        ...
        dateRangeFilter={{
          startColumnId: 'payable_date',
          endColumnId: 'payable_date',
          title: '应付日期',
        }}
        filters={[
          {
