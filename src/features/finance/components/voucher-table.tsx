...
export function VoucherTable({ onApprove, refreshKey = 0 }: VoucherTableProps) {
  ...
  const columns = voucherColumns({ onApprove })
  ...
  return (
    ...
    >
      <DataTableToolbar
        ...
        dateRangeFilter={{
          startColumnId: 'voucher_date',
          endColumnId: 'voucher_date',
          title: '凭证日期',
        }}
      />
